...
let movePJ = 0;
let skyPJ = 0;
let imgPJ = "public/images/avatar-prueba.webp";
let perfilPJ = true;
let jumpPJ = false;
let personaje;
...
function caminar(){
     if (perfilPJ === true) {
        movePJ = movePJ + 10;
        imgPJ = "public/images/avatar-prueba.webp";
    } else if (perfilPJ === false){
        movePJ = movePJ - 10;
        imgPJ = "public/images/avatar-prueba_back.webp";
    } 
    if (jumpPJ === true){
        skyPJ = 30;   
        setTimeout(()=>{
...
function paintSky(){
    ...
    skyElement =
        `<div class="sky_day" style="left: ${skyMove}px;">
            <div class="nube1 nube"><img src="public/images/nube.png" alt="img nube"></div>
            <div class="nube2 nube"><img src="public/images/nube.png" alt="img nube"></div>
            <div class="nube3 nube"><img src="public/images/nube.png" alt="img nube"></div>
        </div>`;
    skyElement2 =
